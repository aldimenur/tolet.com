...
function Register() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1653313262184-37751b98a190?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764")`,
      }}
    >
      {/* NAVBAR DISINI */}
